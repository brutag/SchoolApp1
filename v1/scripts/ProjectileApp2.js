    ...
    if (velocityInput.value < 1)
        {
            ...
            {
                alert("Too fast! Velocity cannot be more than the speed of light!");
                velocityInput.value = "";
            }
}
...
function calculate(angle, velocity)
{
    ...
    document.getElementById("height").innerHTML = calcHeight(verticalVelocity, tMaxHeight);
    document.getElementById("distance").innerHTML = calcDistance(horizontalVelocity, tLanding);
}
